...
-- 4. Modify the query shown gives the number of routes that visit either London Road (149) or Craiglockhart (53). 
...
-- 6. Modify the query so it is similar to the previous one, however by joining two copies of the stops table we can refer to stops 
...
-- 10. Find the routes involving two buses that can go from Craiglockhart to Lochend. Show the bus no. and company for the first bus, 
--     the name of the stop for the transfer, and the bus no. and company for the second bus
